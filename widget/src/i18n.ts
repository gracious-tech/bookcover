...
// currently active language) — add an entry here (plus a locales/<code>.ts catalog) to
// support another language; the switcher UI in PreviewPane.vue reads this list directly, so
// it never needs updating when a locale is added or removed.
